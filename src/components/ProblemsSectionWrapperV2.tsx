...
import ProblemSelectorV2 from "./ProblemSelectorV2";
import { ScrollReveal, SectionHeading } from ".";
...
export default function ProblemsSectionWrapperV2() {
    ...
    >
      <div id="problems" className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <ScrollReveal delay={100}>
          <ProblemSelectorV2 onProblemChange={setSelectedProblemId} />
        </ScrollReveal>

        {/* Value Framework */}
        <ScrollReveal delay={200}>
          <p className="mb-6 mt-10 text-center text-lg font-semibold text-text">
            These are just a few examples. Ultimately, everything we do
